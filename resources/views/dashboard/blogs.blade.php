                ...
                <div class="col-12 col-lg-8">
                    <div class="card shadow border mb-0">
                        <div class="card-header bg-white p-4">
                            <h4 class="card-title mb-0 text-capitalize pull-left">Blogs</h4>
                            <a href="{{route('admin-add-blog')}}" class="btn btn-success pull-right">Create Blog</a>
                        </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($blog->active == '1')
                                                    <a href="{{route('update-blog-status',['active' => '0', 'blog_id' => $blog->id])}}" class="btn btn-sm btn-success">Active</a>
                                                @else
                                                    <a href="{{route('update-blog-status',['active' => '1', 'blog_id' => $blog->id])}}" class="btn btn-sm btn-danger">Inactive</a>
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{route('blog-details',['id' => $blog->id])}}" class="btn btn-sm btn-success">View Detail</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
